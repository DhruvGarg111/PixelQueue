...
export function CanvasStage({ imageUrl, imageWidth, imageHeight }) {
    ...
    const renderedAnnotations = useMemo(() => {
        // ⚡ Bolt Optimization: Wrap the mapping of existing canvas elements in a useMemo hook
        // to prevent React and Konva from needlessly re-evaluating and reconciling the entire list
